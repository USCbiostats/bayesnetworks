...
public:
  ...
  // Copy constructor
  network(const network &n2) {Npar = n2.Npar; par = n2.par;}

  // Getters
  IntegerVector getNpar(){return Npar;};
  IntegerMatrix getpar(){return par;};
  ...
  // Initializer
  void Initialize(int P, int N, double phi, double omega,
                  NumericMatrix X,
                  NumericVector &sumX,
                  NumericMatrix &sumXX,
                  int InitialNetwork,
